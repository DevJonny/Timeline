...
| `type` | `age`, `empire`, `ruler`, `person`, `war`, `battle`, `event` |
...
| `importance` | 1 (era-defining) to 5 (minor). Drives what appears at which zoom. |
| `keywords` | Lowercase hyphenated slugs. Drive filtering and grouping. |
